...
exports.getLargestPalindrome = (N) => {
  ...
  let start = lower;
  // store the lower bound of the second number

  // iterate through range of multiplicands
  for (let i = lower; i < upper; i++) {

    for (let j = start; j < upper; j++) {
      // check if the product is a palindrome
      if (i * j > largestPalindrome) {
        if (isPalindrome(i * j)) {
          // check isPalindrome after check if its larger
...
//
//
console.log(9 == exports.getLargestPalindrome(1))
console.log(9009 == exports.getLargestPalindrome(2))
console.log(906609 == exports.getLargestPalindrome(3))
